...
describe('Module 4 Project Tests', () => {
  describe('English Language', () => {
    ...
    */
    ...
    test(`TEXT_OPT_FAV_FOOD_4 is visible`, () => {
      render(<App lang="en" />)
      expect(screen.queryByText(en.TEXT_OPT_FAV_FOOD_4)).toBeVisible()
    })

    test(`TEXT_SUBMIT is visible`, () => {
      render(<App lang="en" />)
      expect(screen.queryByText(en.TEXT_SUBMIT)).toBeVisible()
    })
  ...
  describe('Spanish Language', () => {
    ...
    */
      ...
      test(`TEXT_OPT_FAV_FOOD_4 is visible`, () => {
        render(<App lang="esp" />)
        expect(screen.queryByText(esp.TEXT_OPT_FAV_FOOD_4)).toBeVisible()
      })
  
      test(`TEXT_SUBMIT is visible`, () => {
        render(<App lang="esp" />)
        expect(screen.queryByText(esp.TEXT_SUBMIT)).toBeVisible()
      })
  ...
  describe('getEntriesByKeyPrefix', () => {
    test('can extract the correct data test 1', () => {
    /*
      👉 TASK 4 part 2
    ...
    */
    ...
    test('can extract the correct data test 2', () => {
        expect(getEntriesByKeyPrefix({
          abc_1: "data_abc_1",
          abc_2: "data_abc_2",
          xyz_1: "data_xyz_1",
      ...
      test('can extract the correct data test 3', () => {
        expect(getEntriesByKeyPrefix({
          abc_1: "data_abc_1",
          abc_2: "data_abc_2",
          xyz_1: "data_xyz_1",
...
function getEntriesByKeyPrefix(obj, keyPrefix) {
  ...
  */
    let arr = Object.entries(obj).filter(([key]) => keyPrefix === key.substring(0,keyPrefix.length))
  return arr
}